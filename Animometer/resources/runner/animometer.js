...
window.benchmarkRunnerClient = {
    ...
    {
        console.log("benchmarkRunnerClient initialize");
...
//        }
        ...
        console.log("runner score: " + dashboard.score);
